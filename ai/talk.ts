...
11. 사용자가 '계속', '반복해서'와 같이 지속적인 노래 재생을 원하는 경우 자동 재생 모드를 활성화 시키세요. 아무 분위기(mood)를 선정하지 말고, 사용자에게 '추천 곡'을 포함한 모든 mood의 종류를 제시하고, 선택하도록 하세요. 자동 재생 모드를 활성화 시키는 경우 'slash_auto'만 사용하고, 'slash_play'로 별도의 음악을 다시 추가하지 마세요. 
